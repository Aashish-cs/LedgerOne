...
public class PortfolioController {
    ...
    ApiResponse<List<PortfolioDtos.PortfolioResponse>> list() {
        return ApiResponse.ok("Paper account loaded", portfolioService.list(currentUser.entity()));
    }
    ...
    ResponseEntity<ApiResponse<PortfolioDtos.PortfolioResponse>> create(@Valid @RequestBody PortfolioDtos.PortfolioCreateRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.ok("Paper account created", portfolioService.create(currentUser.entity(), request)));
    }
    ...
    ApiResponse<PortfolioDtos.PortfolioResponse> rename(
        ...
        return ApiResponse.ok("Paper account renamed", portfolioService.rename(currentUser.entity(), portfolioId, request));
    }
    ...
    ApiResponse<Map<String, Boolean>> delete(@PathVariable UUID portfolioId) {
        ...
        return ApiResponse.ok("Paper account deleted", Map.of("deleted", true));
    }
}
